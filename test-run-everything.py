...
# Set up logging
logging.basicConfig(filename='newsletter_process.log', level=logging.INFO,
...
def main():
    start_time = time.time()
    logging.info("Starting newsletter process")
    ...
    logging.info("Newsletter process completed")
